...
\begin{figure}[H]
    \centerline{\includegraphics[width=\textwidth]{./Design/Prototyping/Change_password_prototyping.pdf}}
...
\noindent \textbf{Item}(\underline{ItemID}, \emph{LocationID}, \emph{ItemTypeID}, ItemName, ItemValue, LoanRate, ItemClass, FuseRating, )
