...
\subsection{Class Definitions}
    ...
    \begin{figure}[H]
        \centerline{\includegraphics[width=450px]{./Design/Class_Definitions/Class_diagrams.pdf}}
...
\noindent \textbf{Item}(\underline{ItemID}, \emph{LocationID}, \emph{ItemTypeID}, ItemName, Value, ItemClass, FuseRating, )

\noindent \textbf{Customer}(\underline{CustomerID}, Forename, Surname, Company, Street, Town, PostCode, MobileNumber, Landline, Email)

\noindent \textbf{Loam}(\underline{LoanID}, LoanRate, LoanLength)

\noindent \textbf{LoanItem}(\underline{LoanItemID}, \emph{LoanID}, \emph{CustomerID}, Quantity)

\noindent \textbf{PATtest}(\underline{PATtestID}, TestDate)

\noindent \textbf{ItemTest}(\underline{ItemTestID}, \emph{ItemID}, PATtestNotes, ComponentTypem, ComponentResult, ComponentNotes, TestResult)
