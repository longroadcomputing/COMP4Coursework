...
\subsubsection{SQL query getting all the items from the Item table in the database ready to be formatted and displayed on screen}
...
\subsubsection{SQL query getting all the loans from the Loan table in the database ready to be formatted and displayed on screen}
...
\subsubsection{SQL query getting all the loan items from the LoanItem table in the database ready to be formatted and displayed on screen}
...
\subsubsection{SQL query getting all the item tests from the ItemTest table in the database ready to be formatted and displayed on screen}
