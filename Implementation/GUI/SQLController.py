...
:Company,:Street,:Town,:PostCode,:Mobile,:Landline,:Email)""")
        ...
        query.bindValue(":Company",values["Surname"])
        query.bindValue(":Street",values["Street"])
        query.bindValue(":Town",values["Town"])
        query.bindValue(":PostCode",values["County"])
        query.bindValue(":Mobile",values["PostCode"])
        query.bindValue(":Landline",values["Email"])
        query.bindValue(":Email",values["PhoneNumber"])
