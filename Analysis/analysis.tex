...
\ElsIf{$Item = ItemMatch$}
    \SET{$Action$}{$Update Item Quantity$}
\EndIf
\end{algorithmic}
\end{algorithm}
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{./Analysis/Dataflow/New_System/New_Sys_Data_flow_new_item}
    \caption{Enter New Item.} \label{fig:print_function_result}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=\textwidth]{./Analysis/Dataflow/New_System/New_Sys_Data_flow_update.pdf}
